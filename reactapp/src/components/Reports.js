...
function Reports() {
  ...
  const handleSortBy = (option) => {
    ...
    const fetchInventoryQuantity = async () => {
        try {
          const response = await axios.get('https://8080-aabbafaeecebdfaddeebcaddacebceecbecadec.project.examly.io/inventory/total-quantity');
      ...
      const fetchSalesData = async () => {
        try {
          const response = await axios.get('https://8080-aabbafaeecebdfaddeebcaddacebceecbecadec.project.examly.io/sales/getall');
