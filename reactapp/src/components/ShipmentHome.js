...
export default function ShipmentHome() {
  ...
  const fetchShipments = async () => {
    const result = await axios.get("https://8080-decacabddcbafaddeebcaddaceaeaadbdbabf.project.examly.io/shipment");
    setUsers(result.data);
  };

  const deleteUser = async (id) => {
    await axios.delete(`https://8080-decacabddcbafaddeebcaddaceaeaadbdbabf.project.examly.io/shipment/delete/${id}`);
    fetchShipments();
  };
