...
const ProductList = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get('https://8080-aedecebfbdffcfaddeebcaddaceaeaadbdbabf.project.examly.io/product');
  ...
  const handleAddProduct = async (event) => {
    ...
    try {
      await axios.post('https://8080-aedecebfbdffcfaddeebcaddaceaeaadbdbabf.project.examly.io/product', newProduct);
      fetchProducts();
      resetForm();
    } catch (error) {
      console.error(error);
  ...
  const handleDeleteProduct = async (productId) => {
    try {
      ...
      await axios.delete(`https://8080-aedecebfbdffcfaddeebcaddaceaeaadbdbabf.project.examly.io/product/${productId}`);
      fetchProducts();
    } catch (error) {
      console.error(error);
    }
  ...
  const handleUpdateProduct = async (event) => {
    ...
    try {
      await axios.put(`https://8080-aedecebfbdffcfaddeebcaddaceaeaadbdbabf.project.examly.io/product/${editProductID}`, updatedProduct);
      fetchProducts();
      resetForm();
    } catch (error) {
      console.error(error);
